...
int main ()
{
char word[5], line[100],atm_nm[4],x[9],y[9],z[9],slno[6],ch_id[20000],store_atm_nm[20000][4], store_res_nm[20000][4],res_nm[4],res_no[5],aw[1030];
FILE *f1,*f2; 
int i,c1=0,c2=0,store_slno[20000],store_res_no[20000],w=0,w1=0;
float tot_x=0.0,tot_y=0.0,tot_z=0.0,cm_x=0,cm_y=0,cm_z=0,store_x[20000],store_y[20000],store_z[20000];
f1 = fopen("3fe0.pdb","r"); 
f2 = fopen ("outday2.pdb","w");
...
if(aw[i]=='S')
w=32;
tot_x=tot_x+w*store_x[i];
tot_y = tot_y+w*store_y[i];
tot_z=tot_z+w*store_z[i];
w1=w1+w;
}      
cm_x= tot_x/w1;cm_y=tot_y/w1; cm_z=tot_z/w1;
